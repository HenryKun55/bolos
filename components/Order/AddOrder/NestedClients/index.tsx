...
import { NestedProductInput } from '../NestedProduct'

type NestedProductClientProps = {
  control: Control<FormData>
}

const NestedClientInput = ({ control }: NestedProductClientProps) => {
        ...
        <Controller
          ...
          render={({ field: { value, onChange, onBlur, disabled } }) => (
            <View>
              ...
              <NestedProductInput nestedIndex={index} control={control} />
              <Button
